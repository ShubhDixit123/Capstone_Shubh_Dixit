{% macro build_external_table(
    table_name,
    folder_name,
    database_name='CT_SHUBH_DIXIT_DB',
    schema_name='EXTERNAL',
    stage_name='CT_SHUBH_DIXIT_DB.BRONZE.BRONZE_STAGE',
    file_format='CT_SHUBH_DIXIT_DB.BRONZE.JSON_FORMAT'
) %}
